...
import com.pikkart.trial.teratour.GLTextureView;
import com.pikkart.trial.teratour.Mesh;
import com.pikkart.trial.teratour.RenderUtils;
import javax.microedition.khronos.egl.EGLConfig;
import javax.microedition.khronos.opengles.GL10;

import com.pikkart.trial.teratour.VideoMesh;
...
public class ARRenderer implements GLTextureView.Renderer
{
    ...
    private static boolean videoMeshLoaded = false;
    ...
    public void InitializeVideoMesh(String videoUrl){
        String video_Url = "media/" + videoUrl + ".mp4";
//        if(videoUrl.equals("3_1422")) {https://storage.googleapis.com/teratour/3_1422.mp4
            videoMesh.InitMesh(context.getAssets(), video_Url, "pikkart_keyframe.png", 0, true, null);
//        }
//        else{
//            videoMesh.InitMesh(context.getAssets(), "https://storage.googleapis.com/teratour/3_1547.mp4", "pikkart_keyframe.png", 0, false, null);
//        }
        videoMeshLoaded = true;
    }
     ...
     * @param pMatrix where to store the computed matrix
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        if(RecognitionFragment.isTracking()) {
            ...
            //Check if videoMesh is already loaded
            if (currentMarker.isTracking() && !videoMeshLoaded){
                InitializeVideoMesh(currentMarker.getId());
            }
        ...
        else if (videoMeshLoaded){

            //videoMesh.pauseVideo();
            videoMeshLoaded = false;
        }
